...
class SX_TabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        firstNavController.tabBarItem = UITabBarItem(title: nil, image: UIImage(named: "Home"), selectedImage: UIImage(named: ""))
        ...
        secondNavController.tabBarItem = UITabBarItem(title: nil, image: UIImage(named: "Application"), selectedImage: UIImage(named: ""))
        ...
        thirdNavController.tabBarItem = UITabBarItem(title: nil, image: UIImage(named: "Mine"), selectedImage: UIImage(named: ""))
    ...
    func setTbaBarApperence() {
        ...
        tabBarApperence.backgroundImage = UIImage(named: "")
