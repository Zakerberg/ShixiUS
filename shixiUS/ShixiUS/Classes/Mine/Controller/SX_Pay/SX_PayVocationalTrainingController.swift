...
extension SX_PayVocationalTrainingController {
    ...
    func fetchData() {
        let url = SX_Mine_OrderRecord + "token=\(String(describing: USERDEFAULTS.value(forKey: "token")!))" + "&userId=\(String(describing: USERDEFAULTS.value(forKey: "userId")!))" + "&iscate=3"
